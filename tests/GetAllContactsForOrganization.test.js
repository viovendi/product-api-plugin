...
it('should verify if the GetAllContactsForOrganization action works as expected', async () => {
    ...
    // const result = await GetAllContactsForOrganization.operation.handler({ inputParameters });
