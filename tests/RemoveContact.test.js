const RemoveContact = require('../actions/RemoveContact');
...
it('should verify if the RemoveContact action works as expected', async () => {
    ...
    // const result = await RemoveContact.operation.handler({ inputParameters });
