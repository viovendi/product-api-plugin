const SearchContacts = require('../../actions/DeleteContact');
...
xit('should verify if the SearchContacts action works as expected', async () => {
    ...
    // const result = await SearchContacts.operation.handler({ inputParameters });
